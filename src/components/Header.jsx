...
const Header = () => {
  ...
  return (
    <header className="absolute w-full z-50 transiton-all duration-300">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 md:h-20">
        ...
        >
          <div className="h-10 w-10 rounded-xl bg-gradient-to-r from-gray-500 to-gray-100 flex items-center justify-center text-purple-900 font-bold text-xl mr-3">
            M
          </div>
        ...
        <div className="md:flex hidden items-center space-x-4">
          <motion.a
            ...
            className="text-gray-700 dark:text-gray-300 hover:text-violet-600 dark:hover:text-violet-400 transiton-colors duration-300"
            href="https://github.com/Messias-Fernandes-Dev"
            target="_blank"
          >
      ...
      <motion.div
        ...
        className="md:hidden over-flow-hidden bg-white dark:bg-gray-900 shadow-lg px-4 py-5 space-y-5"
      >
        ...
        <div className="pt-4 border-t bordder-gray-200 dark:border-gray-700">
            ...
            >
              ...
              <form className="space-y-4">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.97 }}
                  className="w-full px-4 py-2 bg-gradient-to-r from-violet-600 to-violet-400 hover:from-violet-700 hover:to-purple-700 transition-all duration-300 rounded-lg shadow-md hover:shadow-violet-600/50"
                >
                  Send Message
                </motion.button>
              </form>
